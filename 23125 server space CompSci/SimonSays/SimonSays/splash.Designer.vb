...
Partial Class splash
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Start by clicking the start button. "
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Listen to the pattern played. "
        '
        'Label3
        '
        ...
        Me.Label3.Text = "Then enter the pattern you heard."
        '
        'Label4
        '
        ...
        Me.Label4.Text = "If you miss a step, continue from where you left off. "
        '
        'Label5
        '
        ...
        Me.Label5.Size = New System.Drawing.Size(422, 20)
        Me.Label5.TabIndex = 5
        Me.Label5.Text = "Each time you input a color button, your score will increase."
        '
        'splash
        '
